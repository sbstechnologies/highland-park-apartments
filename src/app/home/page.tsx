          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-14 mb-10 md:mb-12">
            ...
            <div className="md:flex md:items-center">
              <p className="font-[Plus_Jakarta_Sans] text-[15px] sm:text-[16px] md:text-[19px] leading-[1.75] text-[#9faac0] max-w-[680px]">
                ...
                Highland Park feels effortless. Unwind by our sparkling swimming
                pool, take your dog to the fenced Bark Park, enjoy family time
                at the on-site playground, or take advantage of the convenient
                resident laundry center and outdoor grilling areas.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-[1920px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 xl:gap-28 items-center">
          ...
          <div className="lg:pl-8 xl:pl-12">
            <p className="font-[Plus_Jakarta_Sans] text-sm md:text-base text-[#5a6260] text-justify leading-relaxed max-w-xxl">
              Highland Park places you in a connected Sherman location
              surrounded by local dining, retail hubs, and outdoor recreation.
              Enjoy seamless everyday commutes along US-75 and Highway 82,
              bringing Downtown Sherman, Austin College, and the shores of Lake
              Texoma right to your fingertips.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="h-[350px] w-full overflow-hidden rounded-2xl sm:h-[450px] lg:h-[550px]">
            <iframe
              src={`https://www.google.com/maps?q=${encodeURIComponent(
                `Highland Park Apartment Homes, ${siteConfig.address}`,
              )}&output=embed`}
              title="Highland Park Apartment Homes location map"
