...
function getFloorPlanAlt(plan: FloorPlan): string {
  ...
  if (title.includes("1x1 - u")) {
    return "1x1 U one bedroom one bath apartment floor plan at Highland Park Apartment Homes in Sherman, Texas";
  }

  if (title.includes("1x1")) {
    return "1x1 one bedroom one bath apartment floor plan at Highland Park Apartment Homes in Sherman, Texas";
  }

  if (title.includes("2x2 - r")) {
    return "2x2 R two bedroom two bath apartment floor plan at Highland Park Apartment Homes in Sherman, Texas";
  }

  if (plan.beds.toLowerCase().includes("1 bedroom")) {
    return "One bedroom one bath apartment floor plan at Highland Park Apartment Homes in Sherman, Texas";
  }

  if (plan.beds.toLowerCase().includes("2 bedroom")) {
    return "Two bedroom two bath apartment floor plan at Highland Park Apartment Homes in Sherman, Texas";
  }

  return `${plan.title} apartment floor plan at Highland Park Apartment Homes in Sherman, Texas`;
}

function getInteriorAlt(plan: FloorPlan): string {
  return `${plan.title} apartment interior at Highland Park Apartment Homes in Irving, Texas`;
}
      ...
      <section className="relative mx-auto min-h-[620px] overflow-hidden bg-[#1f376d] px-6 pb-20 pt-[84px] text-[#F5F2ED] md:px-20 md:py-28 lg:px-40">
        ...
        <div className="relative z-10 max-w-[720px]">
          <p className="mb-6 mt-[15px] font-[Plus_Jakarta_Sans] text-xs font-bold uppercase tracking-[0.3em] text-[#E09428]">
            Highland Park Apartment Homes · IRVING, TX
          </p>
