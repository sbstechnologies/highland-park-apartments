...
========================= */}
        ...
        <motion.p className="font-[Plus_Jakarta_Sans] text-[18px] font-normal leading-[1.9] tracking-[0.01em] text-[#4B4B4B]">
          ...
          deletion to{" "}
          <a
            href="mailto:hparkmanager@livenjoymgt.com"
            className="font-semibold text-[#294B86] hover:underline"
          >
            hparkmanager@livenjoymgt.com
          </a>
          .
        </motion.p>
...
========================= */}
        ...
        <motion.p className="font-[Plus_Jakarta_Sans] text-[18px] font-normal leading-[1.9] tracking-[0.01em] text-[#4B4B4B] mb-5">
          ...
          convenience. Highland Park Apartment Homes and LiveNJoy Management are
...
========================= */}
        ...
        <motion.p className="font-[Plus_Jakarta_Sans] text-[18px] font-normal leading-[1.9] tracking-[0.01em] text-[#4B4B4B] mb-5">
          Welcome to Highland Park Apartment Homes. By accessing and using this
        ...
        <motion.p className="font-[Plus_Jakarta_Sans] text-[18px] font-normal leading-[1.9] tracking-[0.01em] text-[#4B4B4B] mb-5">
          Neither Highland Park Apartment Homes, LiveNJoy Management, nor any
          ...
          acknowledge and agree that Highland Park Apartment Homes and LiveNJoy
        ...
        <motion.p className="font-[Plus_Jakarta_Sans] text-[18px] font-normal leading-[1.9] tracking-[0.01em] text-[#4B4B4B] mb-10">
          Highland Park Apartment Homes is committed to compliance with all
