...
const defaultMessages: Message[] = [
  {
    id: 1,
    sender: "bot",
    text: "Hi there! 👋 I'm Lori, your Highland Park Apartment Homes AI assistant. What can I help you with today?",
  },
];
...
export default function LoriChatWidget() {
  ...
  const handleSend = () => {
    ...
    if (input.toLowerCase().includes("location")) {
      reply = "Highland Park Apartment Homes is located in Sherman, TX.";
                    ...
                    onClick={() =>
                      handleQuick(
                        ...
                        item.label === "Plans"
                          ? plansText
                          : item.label === "Pets"
                            ? "🐾 Highland Park Apartment Homes is pet friendly — cats and dogs are welcome."
                            : item.label === "Parking"
                              ? "🚗 Resident Parking is available for residents."
                              : "📝 Apply online anytime through the Highland Park Apartment Homes resident portal.",
                      )
                    }
