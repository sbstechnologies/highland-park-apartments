...
export default function UnitOverview({
  ...
  const [selectedPlan, setSelectedPlan] = useState("1x1");
  ...
  const galleryAlt =
    tab === "photos"
      ? `${previewCategory} at Highland Park Apartment Homes in Sherman, Texas`
      : `${amenityCategory} at Highland Park Apartment Homes in Sherman, Texas`;
      ...
      <div className="mx-auto max-w-[1920px]">
        ...
        <div className="grid items-start gap-6 md:grid-cols-2 md:gap-10">
          ...
          <p className="max-w-[760px] font-[Plus_Jakarta_Sans] text-[15px] leading-relaxed text-[#5a6260] sm:text-base md:pt-2 md:text-[18px]">
            Our community amenities make everyday living at Highland Park
            Apartment Homes relaxing and convenient. Enjoy the swimming pool,
            covered parking, pet-friendly spaces, and comfortable community
            areas designed for everyday living in Sherman, Texas.
          </p>
        </div>
        ...
        <div className="mt-8 flex flex-col gap-4 rounded-[16px] bg-gradient-to-br from-[#e09428] to-[#c87818] p-4 shadow-[0_4px_28px_rgba(224,148,40,0.45)] sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:p-[14px_24px]">
          ...
          <a
            ...
            aria-label={`Call Highland Park Apartment Homes at ${phone}`}
          ...
          <div className="overflow-hidden rounded-[20px] border border-[#ddd7cc] bg-[#fbfaf7] shadow-[0_2px_8px_rgba(26,29,27,0.04)] sm:rounded-[26px]">
            ...
            <div className="relative h-[260px] border-b border-[#ddd7cc] bg-white sm:h-[360px] lg:h-[500px]">
              {floorPlanImage ? (
                <img
                  src={floorPlanImage}
                  alt={`${currentPlan.title} floor plan at Highland Park Apartment Homes`}
